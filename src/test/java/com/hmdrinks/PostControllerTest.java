...
//
//
//        when(postService.getAllPostByType(anyString(), anyString(),any(Type_Post.class),ArgumentMatchers.any(Language.class))).thenReturn(listAllPostResponse);
//
...
//
//
//        when(postService.getAllPost(anyString(), anyString(),ArgumentMatchers.any(Language.class))).thenReturn(listAllPostResponse);
//
